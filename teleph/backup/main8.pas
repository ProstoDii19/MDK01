...
begin
  ...
  SG.Cells[3, SG.RowCount-1]:= fEdit.DateHBEdit1.Text;
  SG.Cells[4, SG.RowCount-1]:= fEdit.eBook.Text;
  SG.Cells[4, SG.RowCount-1]:= fEdit.eWriter.Text;
end;
...
begin
  ...
  fEdit.DateHBEdit1.Text:= SG.Cells[3, SG.Row];
  fEdit.eBook.Text:= SG.Cells[4, SG.Row];
  fEdit.eWriter.Text:= SG.Cells[4, SG.Row];
  //устанавливаем ModalResult редактора в mrNone:
  fEdit.ModalResult:= mrNone;
  //теперь выводим форму:
  fEdit.ShowModal;
  ...
  if fEdit.ModalResult = mrOk then begin
    ...
    SG.Cells[3, SG.Row]:= fEdit.DateHBEdit1.Text;
    SG.Cells[4, SG.Row]:= fEdit.eBook.Text;
    SG.Cells[4, SG.Row]:= fEdit.eWriter.Text;
  end;
end;
...
begin
  ...
  try
    ...
    for i:= 1 to SG.RowCount-1 do begin
      ...
      MyCont.Date:= SG.Cells[2, i];
      MyCont.Book:= SG.Cells[3, i];
  ...
  try
    ...
    while not Eof(f) do begin
      ...
      //добавляем в сетку новую строку, и заполняем её:
        ...
        SG.Cells[3, SG.RowCount-1]:= MyCont.Date;
        SG.Cells[4, SG.RowCount-1]:= MyCont.Book;
        SG.Cells[4, SG.RowCount-1]:= MyCont.Writer;
