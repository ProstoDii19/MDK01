...
begin
  ...
  if (fEdit.eName.Text= '') or (fEdit.eTelephone.Text= '' ) or (fEdit.DateHBEdit1.Text:= '' ) or (fEdit.ePlace.Text= '') then exit;
  ...
  SG.Cells[4, SG.RowCount-1]:= fEdit.ePlace.Text;
end;
...
begin
  ...
  fEdit.ePlace.Text:= SG.Cells[4, SG.Row];
  //устанавливаем ModalResult редактора в mrNone:
  fEdit.ModalResult:= mrNone;
  //теперь выводим форму:
  fEdit.ShowModal;
  ...
  if fEdit.ModalResult = mrOk then begin
    ...
    SG.Cells[4, SG.Row]:= fEdit.ePlace.Text;
  end;
end;
...
begin
  ...
  try
    ...
    for i:= 1 to SG.RowCount-1 do begin
      ...
      MyCont.HB:= SG.Cells[2, i];
      MyCont.Place:= SG.Cells[3, i];
      //записываем их:
      Write(f, MyCont);
    end;
  finally
  ...
  try
    ...
    while not Eof(f) do begin
      ...
      //добавляем в сетку новую строку, и заполняем её:
        ...
        SG.Cells[3, SG.RowCount-1]:= MyCont.HB;
        SG.Cells[4, SG.RowCount-1]:= MyCont.Place;
